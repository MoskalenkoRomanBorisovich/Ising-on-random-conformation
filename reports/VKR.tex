...
\usepackage[left=30mm, top=20mm, right=15mm, bottom=20mm, nohead, nofoot]{geometry} % настройки полей документа
...
\include{Sections/Magnetic_succeptibility}

\include{Sections/Low_temperature}
